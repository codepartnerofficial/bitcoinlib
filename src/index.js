 ...
 * @property {number=} amount
 * @property {boolean=} sendRemaining
 */
...
class Bitcoin {
    ...
    safeVerify = (
        ...
        console.log("pubkey", pubkey, typeof(pubkey))
        return ecc.verify(
    ...
    sendBitcoin(rawtx, vout, outputs, sendBackRemaining = true, privateKey) {
